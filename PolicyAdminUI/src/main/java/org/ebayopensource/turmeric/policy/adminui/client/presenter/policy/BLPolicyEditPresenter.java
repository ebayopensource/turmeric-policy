...
/**
 * The Class BLPolicyEditPresenter.
 */
public class BLPolicyEditPresenter extends PolicyEditPresenter {

	/**
	 * Instantiates a new bL policy edit presenter.
	 * 
	 * @param eventBus
	 *            the event bus
	 * @param view
	 ...
	 *            the service map
	 */
	public BLPolicyEditPresenter(final HandlerManager eventBus,
	...
	public static final String PRESENTER_ID = "BLPolicyEdit";
		...
		this.view.getSaveButton().addClickHandler(new ClickHandler() {
			public void onClick(final ClickEvent event) {
				...
				final GenericPolicy p = getPolicy(view.getPolicyName()
						.getValue(), originalPolicyType, view.getPolicyDesc()
