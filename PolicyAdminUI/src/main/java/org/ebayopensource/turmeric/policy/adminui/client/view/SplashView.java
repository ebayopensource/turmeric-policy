...
public class SplashView extends Composite implements SplashPresenter.Display {
	...
	public SplashView ()
	{
		...
		it.setText(PolicyAdminUIUtil.constants.italian());
	    ...
	    it.addClickHandler(new ClickHandler() {
	            ...
	            /*-{ 
	                var l = @org.ebayopensource.turmeric.policy.adminui.client.view.SplashView::lang;
	                var url = "";
		...
		Anchor en = new Anchor(PolicyAdminUIUtil.constants.english());		
	    ...
	    Anchor fr = new Anchor(PolicyAdminUIUtil.constants.french());
	    fr.setEnabled(false);
		...
		this.submitButton = new Button(PolicyAdminUIUtil.constants.enter());
		this.loginLabel = new Label(PolicyAdminUIUtil.constants.login());
		this.login = new TextBox();
		this.passwordLabel = new Label(PolicyAdminUIUtil.constants.password());
		this.password = new PasswordTextBox();
		this.domainLabel = new Label(PolicyAdminUIUtil.constants.domain());
