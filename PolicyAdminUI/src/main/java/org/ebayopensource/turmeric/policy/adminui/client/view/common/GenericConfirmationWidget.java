...
import org.ebayopensource.turmeric.policy.adminui.client.model.Entity;
...
public class GenericConfirmationWidget extends PopupPanel {
	...
	public GenericConfirmationWidget(UserAction action, String textMessage, Entity entity) {
		...
		confirmButton = new Button(PolicyAdminUIUtil.policyAdminConstants.confirm());
		ignoreButton = new Button(PolicyAdminUIUtil.policyAdminConstants.cancel());
