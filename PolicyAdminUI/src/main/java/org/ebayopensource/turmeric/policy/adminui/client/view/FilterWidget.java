...
public class FilterWidget extends Composite implements Filterable {
    ...
    public FilterWidget() {
        ...
        applyButton = new Button(PolicyAdminUIUtil.constants.apply());
    ...
    public void createAdvancedPanel () {
        advancedPanel = new DisclosurePanel(PolicyAdminUIUtil.constants.more());
    ...
    public void createMetricsWidgets() {
        metricsLabel = new Label(PolicyAdminUIUtil.constants.selectMetrics()+": ");
    ...
    public void createDurationWidgets() {
        intervalLabel = new Label(PolicyAdminUIUtil.constants.over()+": ");
    ...
    public void createDate1Widgets () {
        ...
        date1Label = new Label(PolicyAdminUIUtil.constants.firstDate()+": ");
    ...
    public void createDate2Widgets () {
        date2Label = new Label(PolicyAdminUIUtil.constants.secondDate()+": ");
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getApplyButton()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getCancelButton()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getDate1()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getDate2()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setDate1(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setDate2(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setHour1(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setHour2(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getHour1()
     */
    public int getHour1 () {
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getHour2()
     */
    public int getHour2 () {
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getDuration()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setDuration(int)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setHours1(int[])
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setHours2(int[])
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setDurations(int[])
     */
    public void setDurations(int[] durations) {
        durationInput.clear();
        for (int i=0;i<durations.length;i++) {
            durationInput.addItem(String.valueOf(durations[i])+PolicyAdminUIUtil.constants.hr());
        }
    }
    
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setMetricNames(java.util.List)
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#getSelectedMetricNames()
     */
    ...
    /* (non-Javadoc)
     * @see org.ebayopensource.turmeric.policy.adminui.client.model.Filterable#setSelectedMetricNames(java.util.List)
     */
