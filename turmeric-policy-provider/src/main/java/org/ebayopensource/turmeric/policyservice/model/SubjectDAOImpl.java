...
public class SubjectDAOImpl extends AbstractDAO implements SubjectDAO {
    ...
    public List<Subject> findAllSubjectByName(String name, String subjectType) {
        return getWildcardResultList(Subject.class, 
            "subjectType", subjectType, "subjectName", name);
    }
    ...
    public SubjectGroup findSubjectGroupByName(String name) {
        return getSingleResultOrNull(SubjectGroup.class, "subjectGroupName", name);
    }

    @Override
    public List<SubjectGroup> findAllSubjectGroupByName(String name, String subjectType) {
        return getWildcardResultList(SubjectGroup.class, 
            "subjectType", subjectType, "subjectGroupName", name);
    }
    ...
    public List<SubjectGroup> findSubjectGroupBySubjectName(String name, String subjectType) {
        return findEntityByMemberValue(SubjectGroup.class, "subjectType", subjectType, "subjects", "subjectName", name);
    }
    ...
    @Override
    public List<AuditHistory> getSubjectHistory(long subjectId, Date start, Date end) {
        return getResultList(AuditHistory.class, "category", Category.SUBJECT.name(), 
                             "entityId", subjectId, "auditInfo.createdOn", start, end);
    }

    @Override
    public List<AuditHistory> getSubjectGroupHistory(long subjectId, Date start, Date end) {
        return getResultList(AuditHistory.class, "category", Category.SUBJECTGROUP.name(),
                             "entityId", subjectId, "auditInfo.createdOn", start, end);
    }

    @Override
    public void audit(SubjectKey subjectKey,
                      String operationType,
                      SubjectKey loginSubject) {
        persistEntity(AuditHistory.newRecord(subjectKey, operationType, loginSubject));
    }
    ...
    public void audit(SubjectGroupKey subjectGroupKey,
                      String operationType,
                      SubjectKey loginSubject) {
        persistEntity(AuditHistory.newRecord(subjectGroupKey, operationType, loginSubject));
    }
    
    public static org.ebayopensource.turmeric.security.v1.services.Subject convert(Subject jpaSubject)
                    throws PolicyFinderException {
        org.ebayopensource.turmeric.security.v1.services.Subject result = 
            new org.ebayopensource.turmeric.security.v1.services.Subject();
        ...
        if (auditInfo != null) {
            ...
            try {
                ...
                result.setLastUpdatedDate(DatatypeFactory.newInstance().newXMLGregorianCalendar(
                                updatedOn));
            }
            catch (DatatypeConfigurationException ex) {
                throw new PolicyFinderException(Category.SUBJECTGROUP, jpaSubject.getSubjectType(), null,
                                jpaSubject.getSubjectName(), "Failed to convert subject", ex);
            }
        }
    ...
    public static Subject convert(org.ebayopensource.turmeric.security.v1.services.Subject subject) {
        ...
        return new Subject(subject.getSubjectName(), subject.getSubjectType(),
                           ...
                           (extId==null ? 0:extId.longValue()), subject.getEmailContact());
    }
    ...
    public static org.ebayopensource.turmeric.security.v1.services.SubjectGroup convert(
        ...
        org.ebayopensource.turmeric.security.v1.services.SubjectGroup result = 
            new org.ebayopensource.turmeric.security.v1.services.SubjectGroup();
        result.setSubjectGroupName(jpaSubjectGroup.getSubjectGroupName());
        result.setSubjectType(jpaSubjectGroup.getSubjectType());
        result.setSubjectGroupCalculator(jpaSubjectGroup.getSubjectGroupCalculator());
        ...
        try {
            ...
            throw new PolicyFinderException(Category.SUBJECTGROUP, jpaSubjectGroup.getSubjectType(),
                            null, jpaSubjectGroup.getSubjectGroupName(),
    ...
    public static SubjectGroup convert(org.ebayopensource.turmeric.security.v1.services.SubjectGroup subjectGroup) {
        return new SubjectGroup(
                        subjectGroup.getSubjectGroupName(), subjectGroup.getSubjectType(),
                        subjectGroup.getSubjectGroupCalculator(), subjectGroup.isApplyToEach(),
                        subjectGroup.isApplyToAll(), subjectGroup.getDescription());
    }
//
//    public static org.ebayopensource.turmeric.security.v1.services.GroupCalculatorInfo convert(GroupCalculator jpaGroupCalculator) {
//        org.ebayopensource.turmeric.security.v1.services.GroupCalculatorInfo result =
//            new org.ebayopensource.turmeric.security.v1.services.GroupCalculatorInfo();
