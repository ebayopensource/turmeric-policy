...
public abstract class SubjectBase implements SubjectTypeProvider {
    ...
    public SubjectBase() {
        ...
        impl = (SubjectTypeProvider) Proxy.newProxyInstance(classLoader, interfaces, new JPAAroundAdvice(factory, target));
    }
    ...
    private class SubjectBaseImpl implements SubjectTypeProvider
    {
        ...
        @Override
        public Map<Long, Subject> getSubjectById(Long id) throws PolicyFinderException {
            ...
            org.ebayopensource.turmeric.policyservice.model.Subject jpaSubject = subjectDAO
                            .findSubjectById(id);
            if (jpaSubject != null) {
            	result.put(jpaSubject.getId(), SubjectDAOImpl.convert(jpaSubject));
            }
        ...
        @Override
        public Map<Long, Subject> getSubjectByName(String name) throws PolicyFinderException {
            Map<Long, Subject> result = new HashMap<Long, Subject>();
            List<org.ebayopensource.turmeric.policyservice.model.Subject> jpaSubjects = 
                subjectDAO.findAllSubjectByName(name, subjectType);
            if (jpaSubjects != null) {
        ...
        public SubjectKey createSubject(Subject subject, SubjectKey createdBy)
            ...
            try {
                org.ebayopensource.turmeric.policyservice.model.Subject jpaSubject = 
                    SubjectDAOImpl.convert(subject);
                ...
                throw new PolicyCreationException(Category.SUBJECT, subjectType,
                        null, subject.getSubjectName(), "Failed to create subject", ex);
            }
            finally {
                AuditContext.clear();
            }
        ...
        public Map<Long, SubjectGroup> findSubjectGroupInfoBySubject(Long subjectId)
            ...
            List<org.ebayopensource.turmeric.policyservice.model.SubjectGroup> jpaSubjectGroupList = subjectDAO
                            .findSubjectGroupBySubjectName(subject.getSubjectName(), subjectType);
            if (jpaSubjectGroupList != null && !jpaSubjectGroupList.isEmpty()) {
                for (org.ebayopensource.turmeric.policyservice.model.SubjectGroup jpaSubjectGroup : 
                        jpaSubjectGroupList) {
                    result.put(jpaSubjectGroup.getId(), SubjectDAOImpl.convert(jpaSubjectGroup));
                }
            }
        ...
        @Override
        public Map<Long, SubjectGroup> getSubjectGroupInfoById(Long id) throws PolicyFinderException {
            Map<Long, SubjectGroup> result = new HashMap<Long, SubjectGroup>();
        ...
        public Map<Long, SubjectGroup> getSubjectGroupInfoByName(String name)
            ...
            List<org.ebayopensource.turmeric.policyservice.model.SubjectGroup> jpaSubjectGroups =
                subjectDAO.findAllSubjectGroupByName(name, subjectType);
        ...
        @Override
        public Map<Long, SubjectGroup> getSubjectGroupInfoByType() throws PolicyFinderException {
            Map<Long, SubjectGroup> result = new HashMap<Long, SubjectGroup>();
            List<org.ebayopensource.turmeric.policyservice.model.SubjectGroup> jpaSubjectGroupList = subjectDAO
        ...
        @Override
        public Set<Subject> getExternalSubjectByName(String name) throws PolicyFinderException {
            return null;
        }
        ...
        @Override
        public Map<Long, Subject> getSubjectAssignmentOfSubjectGroup(Long subjectGroupId)
                        throws PolicyFinderException {
            Map<Long, Subject> result = new HashMap<Long, Subject>();
            org.ebayopensource.turmeric.policyservice.model.SubjectGroup jpaSubjectGroup = subjectDAO
        ...
        public SubjectGroupKey createSubjectGroup(SubjectGroup subjectGroup,
            ...
            try {
                org.ebayopensource.turmeric.policyservice.model.SubjectGroup jpaSubjectGroup = 
                    SubjectDAOImpl.convert(subjectGroup);
                ...
                for (Long addId : subjectGroupEditObject.getAddSubjectList()) {
                    org.ebayopensource.turmeric.policyservice.model.Subject subject = subjectDAO.findSubjectById(addId);
                    if (subject != null) {
                ...
                subjectGroupKey.setSubjectGroupName(jpaSubjectGroup.getSubjectGroupName());
                subjectGroupKey.setSubjectType(jpaSubjectGroup.getSubjectType());
                return subjectGroupKey;
            }
            catch (Exception ex) {
                throw new PolicyCreationException(Category.SUBJECTGROUP, subjectType,
                        null, subjectGroup.getSubjectGroupName(), "Failed to create subject group", ex);
            }
            finally {
                AuditContext.clear();
            }
        ...
        public SubjectGroupKey updateSubjectGroup(SubjectGroup subjectGroup,
            ...
            try {
                ...
                if (id == null) {
                    jpaSubjectGroup = subjectDAO.findSubjectGroupByName(subjectGroup.getSubjectGroupName());
                } else {
                    jpaSubjectGroup = subjectDAO.findSubjectGroupById(id);
                }
                if (subjectGroup.getSubjectType() != null) {
                    jpaSubjectGroup.setSubjectType(subjectGroup.getSubjectType());
                }
                if (subjectGroup.getSubjectGroupName() != null) {
                    jpaSubjectGroup.setSubjectGroupName(subjectGroup.getSubjectGroupName());
                }
                if (subjectGroup.getDescription() != null) {
                    jpaSubjectGroup.setDescription(subjectGroup.getDescription());
                }
                if (subjectGroup.getSubjectGroupCalculator() != null) {
                    jpaSubjectGroup.setSubjectGroupCalculator(subjectGroup.getSubjectGroupCalculator());
                }
                ...
                for (Long removeId : subjectGroupEditObject.getRemoveSubjectList()) {
                    org.ebayopensource.turmeric.policyservice.model.Subject subject = subjectDAO.findSubjectById(removeId);
                    if (subject != null) {
                ...
                throw new PolicyUpdateException(Category.SUBJECTGROUP, subjectType,
                        null, subjectGroup.getSubjectGroupName(), "Failed to update subject group", ex);
            }
            finally {
                AuditContext.clear();
            }
        ...
        @Override
        public void deleteSubjectGroup(Long subjectGroupId) throws PolicyDeleteException,
                        PolicyUpdateException, PolicyFinderException {
            subjectDAO.removeSubjectGroup(subjectGroupId);
        }
    
        @Override
        public GroupCalculatorInfo getGroupCalculator(String calculator) throws PolicyProviderException {
            ...
            SubjectGroupType calculatedSG = calcProvider.getCalculatedSG(subjectGroupType);
            if (calculatedSG != null
                    && calculatedSG.getDomain().equalsIgnoreCase(getSubjectType())) {
        ...
        @Override
        public List<GroupCalculatorInfo> getGroupCalculators() throws PolicyFinderException {
            ...
            Collection<SubjectGroupType> allCalculatedSGs = calcProvider.getAllCalculatedSGs();
        ...
        public List<EntityHistory> getAuditHistory(SubjectGroupKey subjectGroupKey,
            ...
            if (subjectGroupId == null) {
                org.ebayopensource.turmeric.policyservice.model.SubjectGroup subjectGroup = 
                    subjectDAO.findSubjectGroupByName(subjectGroupKey.getSubjectGroupName());
        ...
        public List<EntityHistory> getAuditHistory(SubjectKey subjectKey,
            ...
            if (subjectId == null) {
                org.ebayopensource.turmeric.policyservice.model.Subject subject = 
                    subjectDAO.findSubjectByName(subjectKey.getSubjectName());
                if (subject != null) {
        ...
        @Override
        public void audit(SubjectKey subjectKey, String operationType, SubjectKey loginSubject)
                        throws PolicyFinderException {
            subjectDAO.audit(subjectKey, operationType, loginSubject);
        }
    
        @Override
        public void audit(SubjectGroupKey subjectGroupKey, String operationType, SubjectKey loginSubject)
                        throws PolicyFinderException {
        ...
        public List<KeyValuePair> getMetaData(String queryValue) throws PolicyFinderException {
            if (queryValue.equals("Type"))
            {
                    ...
                    try {
                        ...
                        throw new PolicyFinderException(Category.SUBJECT, subjectType, ex);
                    }
                    ret.add(valuePair);
                    return ret;
            }
    ...
    // The following methods are needed to allow wrapping this class with JPA transaction wrapper
    ...
    public SubjectGroupKey createSubjectGroup(SubjectGroup subjectGroup,
                    SubjectGroupEditObject subjectGroupEditObject, SubjectKey createdBy)
                    throws PolicyCreationException, PolicyUpdateException {
        return impl.createSubjectGroup(subjectGroup, subjectGroupEditObject, createdBy);
    }
    ...
    public SubjectGroupKey updateSubjectGroup(SubjectGroup subjectGroup,
                    SubjectGroupEditObject subjectGroupEditObject, SubjectKey createdBy)
                    throws PolicyUpdateException {
        return impl.updateSubjectGroup(subjectGroup, subjectGroupEditObject, createdBy);
    }
